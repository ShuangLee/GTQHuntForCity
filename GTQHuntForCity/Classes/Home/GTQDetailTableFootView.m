...
@interface GTQDetailTableFootView ()

@property (weak, nonatomic) IBOutlet UILabel *titleLabel;

@property (nonatomic, weak) GTQMenuButton *collectButton1;
@property (nonatomic, weak) GTQMenuButton *collectButton2;
@property (nonatomic, weak) GTQMenuButton *collectButton3;
@property (nonatomic, weak) GTQMenuButton *collectButton4;
@property (nonatomic, weak) GTQMenuButton *collectButton5;
@property (nonatomic, weak) GTQMenuButton *collectButton6;
@end

@implementation GTQDetailTableFootView
- (void)awakeFromNib
{
...
- (GTQMenuButton *)createButtonWithTag:(NSInteger)tag;
{
    GTQMenuButton *btn = [GTQMenuButton buttonWithType:UIButtonTypeCustom];
    btn.tag = tag;
    ...
    if (tag != 5) {
        ...
        [btn setBackgroundColor:GTQGolbalGreen];
...
{
    GTQDetailTableFootView *footView = [[NSBundle mainBundle] loadNibNamed:@"GTQDetailFootView" owner:nil options:nil].firstObject;
