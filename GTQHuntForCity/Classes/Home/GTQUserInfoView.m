...
@implementation GTQUserInfoView
...
- (void)awakeFromNib
{
    ...
    if (iOS8) {
        ...
        effectview.contentView.backgroundColor = GTQGolbalGreen;
...
{
    GTQUserInfoView *view =  [[[NSBundle mainBundle] loadNibNamed:@"GTQUserInfoView" owner:nil options:nil] lastObject];
