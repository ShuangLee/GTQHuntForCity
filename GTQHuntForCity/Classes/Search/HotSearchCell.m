...
{
    HotSearchCell *cell = [[[NSBundle mainBundle] loadNibNamed:NSStringFromClass([self class]) owner:nil options:nil] lastObject];
...
- (void)setHotDatas:(NSArray *)hotDatas {
    ...
    //算出间距
    CGFloat margin = (ScreenWidth - 40 - self.hotButton1.bounds.size.width - self.hotButton2.bounds.size.width - self.hotButton3.bounds.size.width - self.hotButton3.bounds.size.width) / 3;
